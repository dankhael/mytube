...
| **CFG-6** | the modal footer | the modal is open | a **"Pague um café ☕ / apoie o desenvolvedor"** entry is shown as a clearly-marked placeholder |
...
- A working donation flow — CFG-6 is a visual placeholder only.
...
- [ ] The donate placeholder reads as "coming soon", not a broken link.
...
5. **Donate target:** **placeholder only** (no real link yet).
