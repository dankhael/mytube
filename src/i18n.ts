...
const EN = {
  ...
  'config.skin.label': 'Theme',
  'config.skin.sub': 'Aurora, or the retro CRT special',
  'config.language.label': 'Language',
  'config.language.sub': 'Interface language',
  'config.shortcut.label': 'Home shortcut',
...
const PT_BR: Record<MessageKey, string> = {
  ...
  'config.skin.label': 'Tema',
  'config.skin.sub': 'Aurora, ou o especial CRT retrô',
  'config.language.label': 'Idioma',
  'config.language.sub': 'Idioma da interface',
  'config.shortcut.label': 'Atalho da home',
