...
<!-- TODO: reconcile scenario IDs against the original specs/metadata.spec.md
     (META-1..3). Scenarios below are derived from the code. -->
...
#### Scenario: Placeholder is treated as missing
...
#### Scenario: Complete video is left alone
...
<!-- TODO: behavior when offline is undocumented as a requirement — videos keep
     placeholders indefinitely with no retry/visibility (inconsistency I3).
     Confirm whether this is intended before specifying it as a guarantee. -->
